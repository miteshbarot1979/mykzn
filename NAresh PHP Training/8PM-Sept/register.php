		...
		<div class="container">
			...
			if(isset($_POST['save']))
			{
				...
				if(mysqli_affected_rows($con)==1)
				{
					...
					$message = "Hi ".$uname."<br>, Thanks Your account created successfully. Please click the below link to activate your account.<br><br><a href='http://localhost/8pmSept/activate.php?key=".$token."' target='_blank'>Activate Now</a><br><br>Thanks<br>Team";
